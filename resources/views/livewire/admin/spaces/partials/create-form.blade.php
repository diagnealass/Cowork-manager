<div id="create-form" class="bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-gray-800 border-4 border-green-500 dark:border-green-600 rounded-2xl shadow-2xl p-8 scroll-mt-6 animate-in fade-in duration-300">
    <form wire:submit.prevent="create" class="space-y-6">

        <!-- Header -->
        <div class="flex items-center justify-between pb-6 border-b-4 border-green-300 dark:border-green-700">
            <div>
                <h3 class="text-3xl font-black text-green-700 dark:text-green-400 flex items-center gap-3">
                    ✨ Créer un nouvel espace
                </h3>
                <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">Remplissez tous les champs pour créer un espace</p>
            </div>
            <button
                type="button"
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md">
                    ...
                    <input
                        type="text"
                        wire:model="name"
                        class="w-full px-4 py-3 border-2 border-green-400 dark:border-green-600 rounded-lg focus:ring-4 focus:ring-green-200 dark:focus:ring-green-800 focus:border-green-600 dark:bg-gray-700 dark:text-white transition-all"
            ...
            <div class="space-y-5">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input
                                ...
                                step="0.01"
                                min="0"
                                class="w-full px-4 py-2.5 border-2 border-green-300 dark:border-green-700 rounded-lg focus:ring-2 focus:ring-green-200 dark:bg-gray-700 dark:text-white"
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md">
                    ...
                    <input
                        type="text"
                        wire:model="address"
                        class="w-full px-4 py-3 border-2 border-green-400 dark:border-green-600 rounded-lg focus:ring-4 focus:ring-green-200 dark:focus:ring-green-800 dark:bg-gray-700 dark:text-white transition-all"
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md">
                    ...
                    <input
                        type="text"
                        wire:model="country"
                        class="w-full px-4 py-3 border-2 border-green-400 dark:border-green-600 rounded-lg focus:ring-4 focus:ring-green-200 dark:bg-gray-700 dark:text-white transition-all"
                        placeholder="France"
                    >
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    @foreach($amenities as $amenity)
                        <label class="flex items-center gap-3 p-3 border-2 border-gray-200 dark:border-gray-600 rounded-lg hover:border-green-400 dark:hover:border-green-600 hover:bg-green-50 dark:hover:bg-gray-700 cursor-pointer transition-all">
                            <input
                                type="checkbox"
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                ...
                <div class="border-4 border-dashed border-green-300 dark:border-green-700 rounded-xl p-8 text-center hover:border-green-500 dark:hover:border-green-500 transition-all bg-green-50 dark:bg-gray-700">
                    <input
                        type="file"
                        wire:model="images"
                        multiple
        ...
        <!-- Footer Actions -->
        <div class="flex flex-col-reverse sm:flex-row justify-end gap-4 pt-6 border-t-4 border-green-300 dark:border-green-700">
...
>
    ...
    type="submit"
    style="
        background: linear-gradient(to right, #3261D1, #3261D1);
        padding: 0.6rem 1.4rem;
        border-radius: 0.65rem;
        box-shadow: 0 6px 18px rgba(50, 97, 209, 0.35);
        position: relative;
        z-index: 999;
        cursor: pointer;
    "
    class="text-white font-semibold transition-all hover:scale-105 active:scale-95 text-base flex items-center justify-center gap-2 hover:shadow-xl"
    onmouseover="this.style.boxShadow='0 10px 25px rgba(50, 97, 209, 0.35)';"
    onmouseout="this.style.boxShadow='0 6px 18px rgba(50, 97, 209, 0.35)';"
>
    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        <path fill-rule="evenodd"
